...
export const SuccessOpenSavingsAccount = ({
  isOpen,
  data,
  ...
  return (
    <SuccessModal hasLogo isOpen={isOpen} hasToast closeModal={() => {}}>
      <Separator size={-360} />
      <BoxView p={SIZES.LG} mb={SIZES.XS * 2} background="background-lightest">
        <View
          ...
          <BoxView
            ...
            align="center"
            alignSelf="center">
            <BoxView align="center" direction="row">
              ...
              <BoxView mb={12} ml={16} style={styles.containerTexts}>
                ...
                <TextCustom
                  ...
                  variation="h6"
                  text={
                    'Afiliaremos esta nueva cuenta a tu número celular para que recibas dinero desde otras billeteras.'
                  }
                  color="neutral-darkest"
                  lineHeight="comfy"
                />
            ...
            <TextCustom
              ...
              variation="h6"
              text={
                'Solo aplica si no tienes otra cuenta ya afiliada a tu número.'
              }
              color="neutral-dark"
              lineHeight="comfy"
            />
